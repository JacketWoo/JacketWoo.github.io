...
前段时间基础架构组、DBA还有云盘团队一起支持了phpredis的RedisCluster的的线上使用，目前线上业务已经稳定，单业务的规模水平是：Qps平均15W，数据量在700G左右。现对这段时间的工作和所遇到的问题进行一次简单总结：  
...
鉴于我们遇到的大部分问题都和驱动内发送命令的逻辑相关，所以最后贴一张phpredis驱动向主节点发送命令逻辑的流程图:  ![send_command (1)](/Users/wuxiaofei-xy/Downloads/send_command (1).png)
